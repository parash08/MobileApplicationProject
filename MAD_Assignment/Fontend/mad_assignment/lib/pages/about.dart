          ...
          child: ListView(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Color.fromARGB(255, 211, 236, 224),
                  borderRadius: BorderRadius.circular(15),
                ),
                child: FutureBuilder(
                  future:
                      fetchAbout(), // Replace with your future data-fetching function
                      ...
                      if (snapshot.hasError) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ListTile(
                              title: Text(
                                aboutList[index].title.toString(),
                                style: TextStyle(
                                    fontSize: 20, fontWeight: FontWeight.bold),
                              ),
                              subtitle:
                                  Text(aboutList[index].description.toString()),
                            );
                          },
                        );
                      }
